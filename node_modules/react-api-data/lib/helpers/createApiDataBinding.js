...
var createApiDataBinding = function (endpointKey, bindingParams, dispatch, bindingsStore, instanceId) {
    ...
    return function (apiData, request) { return ({
        ...
        request: request || getApiDataRequest_1.getApiDataRequest(apiData, endpointKey, params, instanceId) || createApiDataRequest_1.default(endpointKey),
        perform: function (performParams, body) {
            params = __assign(__assign({}, bindingParams), performParams);
            return dispatch(performApiDataRequest_1.performApiRequest(endpointKey, params, body, instanceId, bindingsStore));
        },
        invalidateCache: function () { return dispatch(invalidateApiDataRequest_1.invalidateApiDataRequest(endpointKey, params, instanceId)); },
