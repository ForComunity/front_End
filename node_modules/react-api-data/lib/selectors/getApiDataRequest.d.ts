...
import { EndpointParams, ApiDataRequest } from '../types';
/**
 ...
 * button click.
 */
export declare const getApiDataRequest: (apiDataState: ApiDataState, endpointKey: string, params?: EndpointParams | undefined, instanceId?: string) => ApiDataRequest | undefined;
