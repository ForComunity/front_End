...
var performApiDataRequest_1 = require("./actions/performApiDataRequest");
exports.shouldPerformApiRequest = function (newProps, oldProps, bindings, bindingKey) {
    ...
    var getRequest = function (props, key) {
        return getApiDataRequest_1.getApiDataRequest(props.apiData, bindings[key], props.params[key]);
    };
    ...
    return ((keyParamsHaveChanged(bindingKey) && exports.shouldAutoTrigger(newProps.apiData, bindings[bindingKey]) === true) ||
        (apiDataChanged &&
            hasBeenInvalidated(getRequest(oldProps, bindingKey), getRequest(newProps, bindingKey)) &&
...
function withApiData(bindings, getParams) {
    ...
    return function (WrappedComponent) {
        var WithApiData = /** @class */ (function (_super) {
            ...
            WithApiData.prototype.componentDidUpdate = function (prevProps, prevState) {
                var _this = this;
                ...
                Object.keys(bindings).forEach(function (bindingKey) {
                    if (Array.isArray(prevProps.params[bindingKey])) {
                        ...
                        paramsArray.forEach(function (params, index) {
                            var _a, _b;
                            if (exports.shouldPerformApiRequest(__assign(__assign({}, _this.props), { params: (_a = {}, _a[bindingKey] = _this.props.params[bindingKey][index], _a) }), __assign(__assign({}, prevProps), { params: (_b = {}, _b[bindingKey] = params, _b) }), bindings, bindingKey)) {
                                _this.props.dispatch(performApiDataRequest_1.performApiRequest(bindings[bindingKey], params, undefined, index.toString()));
                            }
                        });
                    }
                    else {
                        if (exports.shouldPerformApiRequest(_this.props, prevProps, bindings, bindingKey)) {
                            _this.props.dispatch(performApiDataRequest_1.performApiRequest(bindings[bindingKey], _this.props.params[bindingKey]));
                        }
                    }
                });
            };
                    ...
                    if (exports.shouldAutoTrigger(_this.props.apiData, endpointKey)) {
                        ...
                        if (Array.isArray(params[propName])) {
                            ...
                            paramsArray.forEach(function (propNameParams, index) {
                                dispatch(performApiDataRequest_1.performApiRequest(endpointKey, propNameParams, undefined, index.toString(), _this.bindingPropNameBindingsStore[propName]));
                            });
                        }
                        else {
                            dispatch(performApiDataRequest_1.performApiRequest(endpointKey, params[propName], undefined, '', _this.bindingPropNameBindingsStore[propName]));
                        }
                    }
                });
            };
                ...
                Object.keys(bindings).forEach(function (propName) {
                    ...
                    if (Array.isArray(params[propName])) {
                        ...
                        addProps[propName] = paramsArray.map(function (propNameParams, index) {
                            return _this.getApiDataBinding(endpointKey, propNameParams, dispatch, propName, index.toString(), apiData);
                        });
                    }
                    else {
