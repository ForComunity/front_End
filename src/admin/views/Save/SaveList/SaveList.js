                  ...
                  <Table responsive hover>
                    ...
                    {items.map((species, index) => {
                      return <tr key={index}>
                        ...
                        <td>
                          <img src={pare_url_file(species.spe_images1)} alt="" className={"img-avatar mr-3"} width={50 + 'px'}/>
                          <img src={pare_url_file(species.spe_images2)} alt="" className={"img-avatar mr-3"} width={50 + 'px'}/>
                          <img src={pare_url_file(species.spe_images3)} alt="" className={"img-avatar mr-3"} width={50 + 'px'}/>
                        </td>
                        <td>
                          <span><Button size="sm" color="ghost-danger"><i
                            className="fa fa-times"/> {species.spe_status === 1 ? "Public" : "private"}</Button></span>
                        </td>
                        <td>
                          <span><Button size="sm" color="ghost-danger"><i
                            className="fa fa-times"/> {species.spe_hot === 1 ? "Khẩn cấp" : "Ổn định"}</Button></span>
                        </td>
                        <td>
